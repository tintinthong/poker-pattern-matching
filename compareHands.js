...
//- the only complexity is reached during a tie in pattern, e.g. if you obtain a full house vs a full house
...
function compareHands(formattedHand1, formattedHand2) {
    ...
    if (formattedHand1.pattern == formattedHand2.pattern) {
        ...
        if (formattedHand1.pattern == "FullHouse") {
            ...
            // if everything else other than a full house
            //- Pair, TwoPair, Three, Flush, Straight
        ...
        //- finding which pattern is better using patternTable
